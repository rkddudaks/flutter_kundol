...
class CardStyle8 extends StatefulWidget {
  final Function(Widget widget)? navigateToNext;
  final WooProduct product;
  final Color cardColor;

  const CardStyle8(this.navigateToNext, this.product, this.cardColor);

  @override
  _CardStyle8State createState() => _CardStyle8State();
}

class _CardStyle8State extends State<CardStyle8> {
  int quantity = 1;
