...
class CardStyle16 extends StatefulWidget {
  final Function(Widget widget)? navigateToNext;
  final WooProduct product;
  final Color cardColor;

  const CardStyle16(this.navigateToNext, this.product, this.cardColor);

  @override
  _CardStyle16State createState() => _CardStyle16State();
}

class _CardStyle16State extends State<CardStyle16> {
  int quantity = 1;
