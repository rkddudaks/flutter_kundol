...
class CardStyle14 extends StatefulWidget {
  final Function(Widget widget)? navigateToNext;
  final WooProduct product;
  final Color cardColor;

  const CardStyle14(this.navigateToNext, this.product, this.cardColor);

  @override
  _CardStyle14State createState() => _CardStyle14State();
}

class _CardStyle14State extends State<CardStyle14> {
  @override
