...
class SuperDealProductsWidget extends StatefulWidget {
  final Function(Widget widget) navigateToNext;

  const SuperDealProductsWidget(this.navigateToNext);

  @override
  _SuperDealProductsWidgetState createState() =>
      _SuperDealProductsWidgetState();
}

class _SuperDealProductsWidgetState extends State<SuperDealProductsWidget> {
  @override
  void initState() {
    super.initState();
