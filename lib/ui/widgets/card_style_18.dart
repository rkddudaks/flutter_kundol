...
class CardStyle18 extends StatefulWidget {
  final Function(Widget widget)? navigateToNext;
  final WooProduct product;
  final Color cardColor;

  const CardStyle18(this.navigateToNext, this.product, this.cardColor);

  @override
  _CardStyle18State createState() => _CardStyle18State();
}

class _CardStyle18State extends State<CardStyle18> {
  int quantity = 1;
