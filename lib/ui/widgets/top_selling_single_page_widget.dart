...
class TopSellingSinglePageWidget extends StatefulWidget {
  final Function(Widget widget)? navigateToNext;

  const TopSellingSinglePageWidget(this.navigateToNext);

  @override
  _TopSellingSinglePageWidgetState createState() =>
      _TopSellingSinglePageWidgetState();
}

class _TopSellingSinglePageWidgetState extends State<TopSellingSinglePageWidget>
    with AutomaticKeepAliveClientMixin<TopSellingSinglePageWidget> {
  @override
  void initState() {
    super.initState();
  }
