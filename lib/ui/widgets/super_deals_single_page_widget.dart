...
class SuperDealSinglePageWidget extends StatefulWidget {
  final Function(Widget widget)? navigateToNext;

  const SuperDealSinglePageWidget(this.navigateToNext);

  @override
  _SuperDealSinglePageWidgetState createState() =>
      _SuperDealSinglePageWidgetState();
}

class _SuperDealSinglePageWidgetState extends State<SuperDealSinglePageWidget>
    with AutomaticKeepAliveClientMixin<SuperDealSinglePageWidget> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        BlocBuilder<SuperDealProductsBloc, SuperDealProductsState>(
          builder: (context, state) {
            switch (state.status) {
              case SuperDealProductsStatus.success:
                return Column(
                  children: [
                    GridView.builder(
              ...
              case SuperDealProductsStatus.failure:
                return Text("Error");
              default:
                return Center(
