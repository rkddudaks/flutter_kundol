...
class SuperDealProductsBloc
  ...
  @override
  Stream<SuperDealProductsState> mapEventToState(
      SuperDealProductsEvent event) async* {
    if (event is GetSuperDealProducts)
      yield await _mapProductsFetchedToState(state);
  }

  Future<SuperDealProductsState> _mapProductsFetchedToState(
      SuperDealProductsState state) async {
