...
class LanguageBloc extends Bloc<LanguageEvent, LanguageState> {
  LanguageBloc(LanguageData languageData) : super(LanguageState(languageData));
  ...
  Stream<LanguageState> _mapLanguageLoadServerToState(
      LanguageData language) async* {
    final sharedPrefService = await SharedPreferencesService.instance;
    ...
    if (selectedLangId == null) {
      final String selectedLangTitle = "English";
      // AppData.settingsResponse.language!.nativeName!;
      final int selectedLangId = 1;
      // int.parse(AppData.settingsResponse.language!.id!);
      final String selectedLangCode = "en";
      // final String selectedLangCode = AppData.settingsResponse.language!.code!;
