...
class ThemeBloc extends Bloc<ThemeEvent, ThemeState> {
  ThemeBloc()
      : super(ThemeState(ThemeData(
        ...
        //  primarySwatch: AppData.colors[AppData.defaultColor] as MaterialColor?,
  ...
  Stream<ThemeState> _mapThemeColorToState(int selectedIndex) async* {
    ...
    yield ThemeState(ThemeData(
      brightness: isDark ? Brightness.dark : Brightness.light,
     // primarySwatch: AppData.colors[selectedIndex] as MaterialColor?,
  ...
  Stream<ThemeState> _mapThemeModeToState(bool isDark) async* {
    ...
    yield ThemeState(ThemeData(
      brightness: isDark ? Brightness.dark : Brightness.light,
    //  primarySwatch: AppData.colors[colorIndex] as MaterialColor?,
